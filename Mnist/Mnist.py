...
class DataRead(object):
    ...
    def save_hdf5(self):
        ...
        save_dir = os.path.join(self.repo_path, 'HDF5')
    ...
    def read_image_file(self, fname, dtype=None):
        with open(fname, 'rb') as f:
            ...
            if dtype is not None:
                ...
                full_image /= 255.  # transfer to 0-1
        return full_image
    ...
    def load(self):
        if True:
            ...
            if not os.path.exists(save_dir):
                os.makedirs(save_dir)
            for url in (self.raw_train_input_gz, self.raw_train_target_gz, self.raw_test_input_gz,
                        self.raw_test_target_gz):
                ...
                if 'images' in repo_file and 'train' in repo_file:
                    ...
                    indat = self.read_label_file(repo_file)[0:self.num_test_sample]
