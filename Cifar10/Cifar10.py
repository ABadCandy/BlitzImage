...
class DataRead(object):
    repo_path = r'E:\BlitzImage\Cifar10'
    ...
    def _valid_path_append(self, path, *args):
        """
    ...
    def global_contrast_normalize(self, X, scale=1., subtract_mean=True, use_std=False,sqrt_bias=0., min_divisor=1e-8):
        """
    ...
    def zca_whiten(self, Xtrain, Xtest, cachedir):
    ...
    def _load_cifar10(self, normalize=True, contrast_normalize=False, whiten=False):
        """
        ...
        """
        cifar = self.dataset_meta['cifar-10']
        workdir, filepath = self._valid_path_append(self.repo_path, '', cifar['file'])
...
if __name__ == '__main__':
    dd = DataRead()
    (Xtrain,Xlabel),(Ytest,Ylabel),clas = dd._load_cifar10()
